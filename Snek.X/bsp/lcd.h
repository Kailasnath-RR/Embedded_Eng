...
*           discarded.  May block or throw away characters if LCD is not ready
...
void LCD_MoveCursorUp(void);
void LCD_MoveCursorDown(void);
void LCD_ShiftCursorTo(int x, int y);
void LCD_createChar(unsigned char loc,const char unsigned pattern[]);